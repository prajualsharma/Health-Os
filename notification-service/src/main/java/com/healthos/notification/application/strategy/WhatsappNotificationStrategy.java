...
@Component
public class WhatsappNotificationStrategy extends AbstractChannelStrategy {

  public WhatsappNotificationStrategy(ProviderSenderFactory providerSenderFactory) {
